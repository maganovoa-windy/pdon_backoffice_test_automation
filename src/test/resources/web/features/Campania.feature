...
Feature: Crear nueva Campaña
  Background:
    El usuario esta logueado en BackOffice

  Scenario Outline:  Exito al crear nueva campaña desde el boton "Nueva Campaña" desde el <sitio_pag>

    Given Se hace click en el botón "Nueva Campaña"
    And se selecciona el pais <pais> del desplegable
    And se ingresa el nombre de la ONG <nombre_ong>
    And se hace click en el botón "Cargar Archivo" de "Logo ONG"
    And se selecciona el archivo de imagen <logo_ong>
    And se ingresa el codigo de la ONG <codigo_ong>
    And se hace click en boton "Continuar"
    And se hace click en el botón "Cargar Archivo" de "Imagen de campaña"
    And se selecciona el archivo de imagen <imagen_campaña>
    And se ingresa el "Titulo de la campaña" <tit_campaña>
    And se ingresa una "Descripcion de campaña" <desc_campaña>
    And se ingresa una fecha "Desde" de inicio de campaña <fecha_ini>
    And se ingresa una fecha "Hasta" de fin de campaña <fecha_fin>
    And se hace click en el boton "Continuar"
    And se ingresa los "Valores de campaña" el primer valor <monto>, primer equivalencia <equiv> y primer descripción <plato_comida>
    And se selecciona el boton "Crear Campaña"
    Then se visualiza la nueva campaña en el listado de campañas del inicio

    Examples:
      |sitio_pag  	        | pais		|nombre_ong	|logo_ong       |codigo_ong	|imagen_campaña	|tit_campaña|desc_campaña		|fecha_ini	|fecha_fin	|monto	|equiv	|plato_comida	|
      |Header   	        |Argentina	|ONG 1		|pruebaONG.jpg  |123456		|imagen_test.jpg|Campaña 1	|Prueba de campaña	|23/08/2022	|23/08/2023	|50		|1		|vaso de agua	|
      |Listado de Campañas	|Argentina	|ONG 1		|pruebaONG.jpg  |123456		|imagen_test.jpg|Campaña 1	|Prueba de campaña	|23/08/2022	|23/08/2023	|50		|1		|vaso de agua	|
